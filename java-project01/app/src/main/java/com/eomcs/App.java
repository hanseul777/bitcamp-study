...
public class App {
  ...
  public static void main (String[] args) {
    ...
    loop: while (true) {
      ...
      switch (command) {
        case "list": BoardHandlerPractice.list(); break;

        case "add": BoardHandlerPractice.add(); break;

        case "update": BoardHandlerPractice.update(); break;

        case "delete": BoardHandlerPractice.delete(); break;

        case "view": BoardHandlerPractice.view(); break;
