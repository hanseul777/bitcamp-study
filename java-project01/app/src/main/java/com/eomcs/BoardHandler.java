...
public class BoardHandler {
  ...
  static void add() {
    ...
    //    boards[size++] = board; -> ArrayList.append(board)를 적으면서 지워짐.
    // 배열에 게시글 정보가 담긴 객체(식판)을 넣는다.
    // board는 로컬변수여서 사라지기 때문에 그 전에 배열에 담아서 저장해둔다.
  ...
  static void delete() {
    ...
    ArrayList.remove(index); // ArrayList한테 시키는거 index에 해당하는 값 지워줘
